...
const TESTIMONIALS = [
  {
    ...
    initials: "AB",
    quote:
      "The clear batch information and easy-to-find documentation give me confidence when reviewing product purity for procurement.",
  ...
  },
  {
    ...
    initials: "SV",
    quote:
      "Trustworthy, batch-specific COAs and Canadian fulfillment make the ordering process feel transparent from start to finish.",
