...
export const FALLBACK_PRODUCTS: ProductCardData[] = [
  {
    ...
    featured: true,
    variants: [
      { id: "v1", name: "5mg", sku: "GLP3-5MG", price: 149.99, inStock: true, isDefault: true },
      { id: "v2", name: "10mg", sku: "GLP3-10MG", price: 249.99, inStock: true },
    ],
  },
  {
    id: "fb-klow",
    ...
    featured: true,
    variants: [{ id: "v3", name: "80mg", sku: "KLOW-80MG", price: 219.99, inStock: true, isDefault: true }],
  },
  {
    id: "fb-5amq",
    name: "5-Amino-1MQ",
    ...
    featured: true,
    variants: [
      { id: "v4", name: "5mg", sku: "5AMQ-5MG", price: 84.99, inStock: true, isDefault: true },
      { id: "v5", name: "50mg", sku: "5AMQ-50MG", price: 299.99, inStock: true },
    ],
  },
  {
    id: "fb-glow",
    ...
    featured: true,
    variants: [{ id: "v6", name: "10mg", sku: "GLOW-10MG", price: 129.99, inStock: true, isDefault: true }],
  },
  {
    id: "fb-kpv",
    name: "KPV",
    ...
    variants: [{ id: "v7", name: "10mg", sku: "KPV-10MG", price: 69.99, inStock: true, isDefault: true }],
  },
  {
    id: "fb-motsc",
    name: "MOTS-C",
    ...
    featured: true,
    variants: [
      { id: "v8", name: "10mg", sku: "MOTSC-10MG", price: 64.99, inStock: true, isDefault: true },
      { id: "v9", name: "40mg", sku: "MOTSC-40MG", price: 189.99, inStock: true },
    ],
  },
  {
    id: "fb-wolv",
    ...
    researchCategory: "Recovery Research",
    featured: true,
    variants: [{ id: "v10", name: "10mg/10mg", sku: "WOLV-10-10", price: 179.99, inStock: true, isDefault: true }],
  },
];
...
export const FALLBACK_SETTINGS: Record<string, string> = {
  ...
  free_shipping_message: "Free expedited shipping on orders over $300 CAD",
...
export const FALLBACK_ANNOUNCEMENTS = [
  ...
  { id: "a3", message: "For research purposes only — laboratory use", link: "/research-disclaimer", linkText: "Disclaimer" },
];
