...
Products sold through OVIpeps are intended exclusively for in-vitro research and laboratory use. They are not intended for human consumption, medical treatment, diagnosis, or veterinary use.
...
export const FALLBACK_FAQS: FallbackFaq[] = [
  {
    ...
    answer:
      "No. Products are sold strictly for laboratory research use and are not intended for human consumption, treatment, diagnosis, or veterinary use. For the most accurate and up-to-date information, please visit our Disclaimer page.",
    category: "RESEARCH",
  },
  {
  ...
  },
  {
    ...
    answer:
      "For optimal stability, keep at a consistent temperature. Refrigeration is highly recommended, as it provides the most stable storage conditions.",
    category: "PRODUCTS",
  },
  {
