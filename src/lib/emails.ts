...
export const emailTemplates = {
  orderConfirmation: (data: {
    ...
    deliveryMethod: "SHIPPING" | "PICKUP"; shippingAmount: string;
    ...
    const deliveryLabel = data.deliveryMethod === "PICKUP" ? "Pick Up" : "Shipping";
